...
export class alertService {
  ...
  constructor(private coolDialogs: NgxCoolDialogsService) {
    ...
    if (!document.getElementById('alertStyle')) {
      ...
      styleNode.innerHTML = '.alert{padding: 10px 15px;position: fixed;top: 200px;width: 200px;font-size: 12px;text-align: center;background: #fff;border-radius: 10px;animation: show-msg 3s;opacity: 0;}';
